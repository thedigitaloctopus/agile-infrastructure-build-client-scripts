...
**NOTE:** If you set your LAPTOP_IP to "BYPASS" - export LAPTOP_IP="BYPASS" in your userdata script, that will bypass all of this system and allow SSH connections from any ip address which is less secure, but, less faff.  
