...
1. configure the toolkit such that it uses a remote bucket in the cloud, "Persist application assets to cloud". All webservers then share this bucket to obtain their assets from. Whilst you application is live, assets must not be deleted from the bucket as this is the only place they are stored.
