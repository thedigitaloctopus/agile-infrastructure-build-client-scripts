...
# <UDF name="BASELINE_DB_REPOSITORY" label="Application DB repository must match with below" oneof="wordydemo-db-baseline,nuocialboss-db-baseline"/>
# <UDF name="APPLICATION_BASELINE_SOURCECODE_REPOSITORY" label="Application Sourcecode repository  must match with above" oneof="wordydemo-webroot-sourcecode-baseline,nuocialboss-webroot-sourcecode-baseline"/>
