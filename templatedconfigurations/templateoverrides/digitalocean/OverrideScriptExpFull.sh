...
#export WS_SIZE="2gb" to override the "export WS_SIZE="1gb" of the selected template.
...
/bin/echo ${BUILDCLIENT_USER}:${BUILDMACHINE_PASSWORD} | /usr/bin/sudo -S -E /usr/sbin/chpasswd 
