...
export BUILD_IDENTIFIER=\"\" #Unique string to identify your build, for example, 'testjoomladeploy'
export TOKEN=\"\" #Your digital ocean personal acccess token
...
export WEBSITE_URL=\"\"  #the URL of the website registered with your DNS provider for example, ok.nuocial.org.uk
...
export JOOMLA_VERSION=\"4.0.0-beta6\"
export APPLICATION_BASELINE_SOURCECODE_REPOSITORY=\"JOOMLA:4.0.0-beta6\"
